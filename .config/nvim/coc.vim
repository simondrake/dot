...
" PYTHON PROVIDERS {{{
" Non-built in version installed
...
" Disable auto complete for Markdown files
autocmd FileType markdown let b:coc_suggest_disable = 1

" organize/add import on save buffer
...
" Add tags to struct
" autocmd FileType go nmap <leader>ta :CocCommand go.tags.add
" Remove tags from struct
" autocmd FileType go nmap <leader>tr :CocCommand go.tags.remove
" Add tags to line
" autocmd FileType go nmap <leader>tal :CocCommand go.tags.add.line
" Remove tags from line
" autocmd FileType go nmap <leader>trl :CocCommand go.tags.remove.line
" Prompt to add tags to struct
" autocmd FileType go nmap <leader>tap :CocCommand go.tags.add.prompt<CR>
" Prompt to remove tags to struct
