...
_G.packer_plugins = {
  ...
  gruvbox = {
    loaded = true,
    path = "/Users/simondrake/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["nvim-neoclip.lua"] = {
    ...
    loaded = true,
    path = "/Users/simondrake/.local/share/nvim/site/pack/packer/start/nvim-neoclip.lua",
  ...
  ["tokyodark.nvim"] = {
    ...
    url = "https://github.com/simondrake/tokyodark.nvim"
  },
  ["vim-fugitive"] = {
    loaded = true,
